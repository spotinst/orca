...
@Component
@Slf4j
class SpotServerGroupCacheForceRefreshTask extends AbstractCloudProviderAwareTask implements RetryableTask {
  ...
  long timeout = TimeUnit.MINUTES.toMillis(40)
  ...
  @Autowired
  SpotServerGroupCacheForceRefreshTask(CloudDriverCacheStatusService cacheStatusService,
